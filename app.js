...
function inicio(){
    ...
    var wmsdepartamentos=new ol.layer.Tile({
        title:'departamentos del peru',
        source: new ol.source.TileWMS({
            projection:'EPSG:4326',
            attributions:'INEI 2017',
            url:'http://175.100.9.36:8080/geoserver/clase03/wms',
            params:{
	...
	function leyendawms(){
		...
		for(i=0;i<sincapas;i++){
			registros.push("http://175.100.9.36:8080/geoserver/clase03/wms?REQUEST=GetLegendGraphic&version=1.1.0&FORMAT=image/png&width=20&height=20&layer=clase03%3ADepartamentos");
